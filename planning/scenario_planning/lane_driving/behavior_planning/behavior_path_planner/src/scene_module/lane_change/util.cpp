  ...
  const autoware_planning_msgs::PathWithLaneId path2, const double interval, const size_t N_sample)
{
  ...
  if (interval < ds) {
    ...
    std::vector<autoware_planning_msgs::PathPointWithLaneId> inner_points;
    std::vector<double> inner_x, inner_y, inner_z;
    if (
      ...
      for (size_t i = 0; i < inner_s.size(); ++i) {
        autoware_planning_msgs::PathPointWithLaneId inner_point;
...
std::vector<LaneChangePath> getLaneChangePaths(
  ...
  const LaneChangeParameters & parameter)
{
  ...
  for (double acceleration = 0.0; acceleration >= -maximum_deceleration;
    ...
    autoware_planning_msgs::PathWithLaneId reference_path;
    ...
    autoware_planning_msgs::PathWithLaneId reference_path1;
    {
    ...
    autoware_planning_msgs::PathWithLaneId reference_path2;
    {
...
bool isLaneChangePathSafe(
  ...
  const autoware_perception_msgs::DynamicObjectArray::ConstPtr & dynamic_objects,
  const geometry_msgs::Pose & current_pose, const geometry_msgs::Twist & current_twist,
  const double vehicle_width, const LaneChangeParameters & ros_parameters, const bool use_buffer,
