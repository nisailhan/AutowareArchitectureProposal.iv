...
private:
  ...
  int
    curvature_smoothing_num_traj_;  //!< @brief point-to-point index distance for curvature calculation for trajectory
  int
    curvature_smoothing_num_ref_steer_;  //!< @brief point-to-point index distance for curvature calculation for reference steer command
