...
#ifndef CONTROL_PERFORMANCE_ANALYSIS_CONTROL_PERFORMANCE_UTILS_H
#define CONTROL_PERFORMANCE_ANALYSIS_CONTROL_PERFORMANCE_UTILS_H
...
namespace control_performance_utils
{
...
inline geometry_msgs::Quaternion createOrientationMsgfromYaw(double yaw_angle)
{
...
#endif  //CONTROL_PERFORMANCE_ANALYSIS_CONTROL_PERFORMANCE_UTILS_H
